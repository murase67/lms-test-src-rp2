...
public class Case14 {
	...
	void test06() {
		...
		// 第２問
		final WebElement answer02 = webDriver.findElement(By.id("answer-1-2"));
		answer02.click();
		getEvidence(new Object() {
		}, "q2");
		scrollBy("370");
		...
		// 第３問
		final WebElement answer03 = webDriver.findElement(By.id("answer-2-0"));
		answer03.click();
		getEvidence(new Object() {
		}, "q3");
		scrollBy("370");
		...
		// 第４問
		final WebElement answer04 = webDriver.findElement(By.id("answer-3-0"));
		answer04.click();
		getEvidence(new Object() {
		}, "q4");
		scrollBy("370");
		...
		// 第５問
		final WebElement answer05 = webDriver.findElement(By.id("answer-4-1"));
		answer05.click();
		getEvidence(new Object() {
		}, "q5");
		scrollBy("370");
		...
		// 第６問
		final WebElement answer06 = webDriver.findElement(By.id("answer-5-1"));
		answer06.click();
		getEvidence(new Object() {
		}, "q6");
		scrollBy("370");
